...
# We provides a tri-class security patch benchmark for fine-grained vulnerability fix detection. The dataset is constructed from source commit records in BigVulFixes and PatchDB, followed by merging, deduplication, artifact collection, SH-oriented candidate screening and manual verification.
